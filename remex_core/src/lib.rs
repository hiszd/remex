...
impl From<Vec<Packet>> for Message {
  fn from(value: Vec<Packet>) -> Self {
    Message {
      msg: Message::string_from_packets(&value),
      packets: value,
    }
  }
}
  ...
  fn test_message_from_string() {
    ...
    assert_eq!(
      ...
      StackVec::<u8, 126>::from_slice(&[
        72, 101, 108, 108, 111, 44, 32, 87, 111, 114, 108, 100, 32, 104, 111, 112, 101, 32, 121,
        111, 117, 39, 114, 101, 32, 108, 105, 115, 116, 101, 110, 105, 110, 103, 46, 32, 73, 32,
        116, 104, 105, 110, 107, 32, 116, 104, 97, 116, 32, 116, 104, 101, 121, 32, 99, 97, 110,
        32, 115, 101, 101, 44, 32, 97, 32, 98, 101, 116, 116, 101, 114, 32, 115, 105, 100, 101, 32,
        111, 102, 32, 109, 101, 46, 32, 76, 101, 116, 39, 115, 32, 107, 101, 101, 112, 32, 116, 97,
        108, 107, 105, 110, 103, 32, 97, 98, 111, 117, 116, 32, 116, 104, 105, 115, 32, 116, 111,
        32, 104, 101, 108, 112, 32, 119, 105, 116, 104
      ])
      .unwrap()
    );
    ...
    assert_eq!(
      ...
      StackVec::<u8, 126>::from_slice(&[
        32, 116, 104, 101, 32, 102, 114, 117, 115, 116, 114, 97, 116, 105, 111, 110, 32, 111, 102,
        32, 110, 111, 116, 32, 114, 101, 109, 101, 109, 98, 101, 114, 105, 110, 103, 32, 116, 104,
        101, 32, 108, 121, 114, 105, 99, 115, 46
      ])
      .unwrap()
    );
  }
